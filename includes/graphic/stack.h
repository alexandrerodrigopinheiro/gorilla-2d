#ifndef G2D_GRAPHIC_STACK_H_
#define G2D_GRAPHIC_STACK_H_
	...
	namespace graphic
	{
		class stack
		{
			public:
				...
				bool initialize(const g2d::graphic::texture& texture, bool verbose = false);
			...
			private:
				...
				bool _verbose { false };
				std::vector<uint> _identity { std::vector<uint>() };
				std::size_t _index { 0 };
				...
				std::vector<g2d::math::size2dd> _size { std::vector<g2d::math::size2dd>() };
