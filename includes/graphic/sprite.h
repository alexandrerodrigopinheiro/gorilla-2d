#ifndef G2D_GRAPHIC_SPRITE_H_
#define G2D_GRAPHIC_SPRITE_H_
	...
	namespace graphic
	{
		class sprite
		{
			public:
				...
				bool initialize(const std::string& filename, std::size_t columns, std::size_t rows, std::size_t length, bool verbose = false);

				bool initialize(const g2d::graphic::texture& texture, std::size_t columns, std::size_t rows, std::size_t length, bool verbose = false);
