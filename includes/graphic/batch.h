#ifndef G2D_GRAPHIC_BATCH_H_
#define G2D_GRAPHIC_BATCH_H_
	...
	namespace graphic
	{
		class batch
		{
			public:
				...
				bool sprite(const std::string& filename, std::size_t columns, std::size_t rows, std::size_t length, bool verbose = false);

				bool layer(const std::string& filename, std::size_t columns, std::size_t rows, std::size_t length, bool verbose = false);
